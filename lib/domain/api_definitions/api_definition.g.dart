...
class _ApiDefinition implements ApiDefinition {
  ...
  @override
  Future<LoginResponse> login(String accessToken, LoginRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'AccessToken': accessToken};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<ProfileResponse> getProfile(String accessToken, String bearer) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'AccessToken': accessToken,
  ...
  @override
  Future<GetWalletResponse> getWallet(String accessToken, String bearer) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'AccessToken': accessToken,
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetWalletResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/wallet',
  ...
  Future<GetAllBanksResponse> getBanks(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllBanksResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/get-banks',
  ...
  @override
  Future<BaseResponse<dynamic>> verifyPin(
    String bearer,
    String accessToken,
    VerifyPinRequest body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
  ...
  Future<DashboardDataResponse> getDashboardData(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<DashboardDataResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/dashboard-data',
  ...
  Future<LinkBvnResponse> linkBvn(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<LinkBvnResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/link-bvn',
  ...
  Future<GetVirtualAccountsResponse> getVirtualAccount(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetVirtualAccountsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/get-virtual-account',
  ...
  Future<GetAllUserBanksResponse> getUserBanks(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllUserBanksResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/get-user-bank',
  ...
  Future<AddBankResponse> addBank(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<AddBankResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/add-bank',
  ...
  Future<FetchAccountNameResponse> fetchAccountName(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<FetchAccountNameResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/fetch-account-name',
  ...
  Future<DeleteBankResponse> deleteBank(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DeleteBankResponse>(
  ...
  Future<MakeBankDefaultResponse> makeBankDefault(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MakeBankDefaultResponse>(
  ...
  Future<GetAllSubProductsResponse> getSubProduct(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllSubProductsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<ValidateBillResponse> validateBill(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<ValidateBillResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/validateBill',
  ...
  Future<GetAllUserTransactionResponse> getTransactionsByType(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllUserTransactionResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<AllNotificationResponse> getAllNotifications(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AllNotificationResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/notifications',
  ...
  Future<MarkNotificationAsReadResponse> markAllNotificationsAsRead(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MarkNotificationAsReadResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<GetAllPromoResponse> getAllPromos(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllPromoResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/promos',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetAllPromoResponse _value;
    try {
  ...
  @override
  Future<BaseResponse<dynamic>> redeemAPromo(
    String accessToken,
    String bearer,
    RedeemAPromoRequest body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
  ...
  Future<GetAllBeneficiariesResponse> getAllBeneficiaries(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllBeneficiariesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/all-beneficiaries',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetAllBeneficiariesResponse _value;
    try {
  ...
  Future<EpinResponse> initiateEpinPurchase(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<EpinResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/epin/purchase',
  ...
  Future<EpinTransactionRequestsResponse> getEpinTransactionRequests(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EpinTransactionRequestsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/epin/requests',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EpinTransactionRequestsResponse _value;
    try {
  ...
  Future<AirtimeNetworksResponse> getAirtimeToCashNetworks(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AirtimeNetworksResponse _value;
    try {
      _value = AirtimeNetworksResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AirtimeGenerateOtpResponse> generateAirtimeToCashOtp(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<AirtimeGenerateOtpResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/airtime-to-cash/otp',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AirtimeGenerateOtpResponse _value;
    try {
      _value = AirtimeGenerateOtpResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AirtimeVerifyOtpResponse> verifyAirtimeToCashOtp(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<AirtimeVerifyOtpResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/airtime-to-cash/verify',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AirtimeVerifyOtpResponse _value;
    try {
      _value = AirtimeVerifyOtpResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AirtimeCheckQuotaResponse> checkAirtimeToCashQuota(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<AirtimeCheckQuotaResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/airtime-to-cash/check-quota',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AirtimeCheckQuotaResponse _value;
    try {
      _value = AirtimeCheckQuotaResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AirtimeTransferResponse> transferAirtimeToCash(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<AirtimeTransferResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AirtimeTransferResponse _value;
    try {
      _value = AirtimeTransferResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AirtimeTransactionHistoryResponse> getAirtimeToCashTransactions(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AirtimeTransactionHistoryResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/userTransactions/airtime_to_cash',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AirtimeTransactionHistoryResponse _value;
    try {
      _value = AirtimeTransactionHistoryResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
