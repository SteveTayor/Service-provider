...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Data&&(identical(other.id, id) || other.id == id)&&(identical(other.firstName, firstName) || other.firstName == firstName)&&(identical(other.lastName, lastName) || other.lastName == lastName)&&(identical(other.name, name) || other.name == name)&&(identical(other.username, username) || other.username == username)&&(identical(other.email, email) || other.email == email)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.userType, userType) || other.userType == userType)&&const DeepCollectionEquality().equals(other.emailVerifiedAt, emailVerifiedAt)&&const DeepCollectionEquality().equals(other.pin, pin)&&const DeepCollectionEquality().equals(other.address, address)&&const DeepCollectionEquality().equals(other.otp, otp)&&const DeepCollectionEquality().equals(other.gender, gender)&&const DeepCollectionEquality().equals(other.dob, dob)&&const DeepCollectionEquality().equals(other.bvn, bvn)&&(identical(other.hasPin, hasPin) || other.hasPin == hasPin)&&const DeepCollectionEquality().equals(other.nin, nin)&&const DeepCollectionEquality().equals(other.bankName, bankName)&&const DeepCollectionEquality().equals(other.accountNumber, accountNumber)&&const DeepCollectionEquality().equals(other.accountName, accountName)&&const DeepCollectionEquality().equals(other.vAccountNum1, vAccountNum1)&&const DeepCollectionEquality().equals(other.vAccountName1, vAccountName1)&&const DeepCollectionEquality().equals(other.vAccountBank1, vAccountBank1)&&const DeepCollectionEquality().equals(other.vAccountNum2, vAccountNum2)&&const DeepCollectionEquality().equals(other.vAccountNum3, vAccountNum3)&&const DeepCollectionEquality().equals(other.vAccountName2, vAccountName2)&&const DeepCollectionEquality().equals(other.vAccountName3, vAccountName3)&&const DeepCollectionEquality().equals(other.vAccountBank2, vAccountBank2)&&const DeepCollectionEquality().equals(other.vAccountBank3, vAccountBank3)&&(identical(other.status, status) || other.status == status)&&(identical(other.currentSessionId, currentSessionId) || other.currentSessionId == currentSessionId)&&const DeepCollectionEquality().equals(other.transactionSessionId, transactionSessionId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,firstName,lastName,name,username,email,phone,userType,const DeepCollectionEquality().hash(emailVerifiedAt),const DeepCollectionEquality().hash(pin),const DeepCollectionEquality().hash(address),const DeepCollectionEquality().hash(otp),const DeepCollectionEquality().hash(gender),const DeepCollectionEquality().hash(dob),const DeepCollectionEquality().hash(bvn),hasPin,const DeepCollectionEquality().hash(nin),const DeepCollectionEquality().hash(bankName),const DeepCollectionEquality().hash(accountNumber),const DeepCollectionEquality().hash(accountName),const DeepCollectionEquality().hash(vAccountNum1),const DeepCollectionEquality().hash(vAccountName1),const DeepCollectionEquality().hash(vAccountBank1),const DeepCollectionEquality().hash(vAccountNum2),const DeepCollectionEquality().hash(vAccountNum3),const DeepCollectionEquality().hash(vAccountName2),const DeepCollectionEquality().hash(vAccountName3),const DeepCollectionEquality().hash(vAccountBank2),const DeepCollectionEquality().hash(vAccountBank3),status,currentSessionId,const DeepCollectionEquality().hash(transactionSessionId),createdAt,updatedAt]);
...
as bool?,nin: freezed == nin ? _self.nin : nin // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: "has_pin") final  bool? hasPin;
