...
//         conversionRatePercent: network.conversionRatePercent,
//         failureReason:
//             'Your airtime conversion request is being processed. '
...
//       final partialReceived =
//           (amount * network.conversionRatePercent / 100) * 0.8;
//       final txn = AirtimeToCashTransaction(
//         id: 'txn_$_txnCounter',
//         reference: ref,
//         dateTime: now,
...
//         conversionRatePercent: network.conversionRatePercent,
//         failureReason:
//             'Some airtime could not be converted. '
