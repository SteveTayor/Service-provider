      ...
      children: [
        Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Add a username to personalize your account.',
        ...
        AppForm(
          isExpanded: false,
                    ...
                    }, buttonText: 'Complete account set-up', formKey: _formKey,
                    children:         [
AppTextField(
  hintText: 'Choose a username',
  suffixIcon: AppSvgIcon(path: Assets.svgs.tickCircle,fit: BoxFit.scaleDown,
  ),
),
                    ],),
        ),       
