...
class TopUpResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BundlegramScaffold(
      ...
      body: 
    ResultWidget(title: 'Top-up successful!', 
    subText: 'Your wallet top-up was successful. ₦10,000 has been added to your Bundlegram wallet.',
     buttonText: 'Go to home', onPressed: (){
      context.pop();
     },),
    );
  }
