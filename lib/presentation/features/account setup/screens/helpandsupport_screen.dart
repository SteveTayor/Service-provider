...
class HelpandsupportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
        ...
        {VoidCallback? onPressed, Widget? extraWidget,}){
      return 
      InkWell(
        onTap: onPressed,
        child: Row(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  8.verticalSpace,
              if (label.isEmpty) const SizedBox() else Text(label,style: context.textTheme.labelMedium,),
    ...
    Column(
      children: [
        40.verticalSpace,
        buildItemRow(Assets.svgs.helpQuestion1StreamlineCore, 
        extraWidget: Text('View FAQs',style:context.textTheme.titleMedium!.copyWith(
          fontSize: 16.sp,
          height: 3,
        ...
        buildItemRow(Assets.svgs.sendEmailMailSendEmailPaperAirplane, 
        extraWidget: Column(
          children: [
            Row(
              children: [
                Text('Enquiry: info@bundlegram.com',
            ...
            Row(
              children: [
                Text('Technical: support@bundlegram.com',
                style:context.textTheme.bodySmall!.copyWith(
                  fontSize: 14.sp,
                  fontWeight: FontWeight.w400,
                  color: AppColors.grey33,)
        ...
        buildItemRow(Assets.svgs.phoneRinging1StreamlineCore, 
        extraWidget: Column(
          children: [
            Row(
              children: [
