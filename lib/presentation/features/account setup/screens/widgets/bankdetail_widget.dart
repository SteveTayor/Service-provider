    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text('Account 2',style: context.textTheme.bodySmall,),
            AppSvgIcon(path: Assets.svgs.recycleBin2StreamlineCore),
          ],
        ),
        22.verticalSpace,
        Text('4440883246',style: context.textTheme.titleLarge!.copyWith(
          fontSize: 40.sp,
          fontWeight: FontWeight.w500,
        ),),
         
        Text('Guaranty Trust Bank',style: context.textTheme.bodyMedium!.copyWith(
